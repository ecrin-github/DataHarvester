...
namespace DataHarvester
{
    public class TestSchemaBuilder
    {
        ...
        {
            ADCompStudyTableBuilder studytablebuilder = new ADCompStudyTableBuilder(_db_conn);
            ...
            ADCompObjectTableBuilder objecttablebuilder = new ADCompObjectTableBuilder(_db_conn);
