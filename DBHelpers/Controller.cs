...
namespace DataHarvester.DBHelpers
{
	public class Controller
	{
		...
		public Controller(DataLayer _common_repo, int _source_id, string source_folder_name, int _harvest_type_id)
		{
		...
		{
			common_repo.DeleteSDStudyTables();
			common_repo.DeleteSDObjectTables();
			common_repo.BuildNewSDStudyTables();
			common_repo.BuildNewSDObjectTables();
		}
